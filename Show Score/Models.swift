...
extension MovieModel {
    ...
    var viewImage: UIImage {
        guard let image = posterImage else { return UIImage(resource: .swiftdata)}
        
        
        
        return UIImage(data: image) ?? UIImage(resource: .swiftdata)
    }
...
//                    print(movieModel.title)
    ...
    static var preview: ModelContainer {
        let previewContainer = try! ModelContainer(for: MovieModel.self, configurations: ModelConfiguration(isStoredInMemoryOnly: true))
        
        // Crear un array de películas de ejemplo
        let sampleMovies = [
            MovieModel(id: 1, title: "Inception", originalTitle: "Inception", overview: "A thief who steals corporate secrets through the use of dream-sharing technology.", popularity: 82.3, posterPath: "/poster1.jpg", backdropPath: "/backdrop1.jpg", releaseDate: "2010-07-16", voteAverage: 8.3, voteCount: 22187, genreIDs: [28, 12, 878], adult: false, video: false),
            MovieModel(id: 2, title: "Interstellar", originalTitle: "Interstellar", overview: "A team of explorers travel through a wormhole in space.", popularity: 75.5, posterPath: "/poster2.jpg", backdropPath: "/backdrop2.jpg", releaseDate: "2014-11-07", voteAverage: 8.6, voteCount: 19123, genreIDs: [12, 18, 878], adult: false, video: false),
            MovieModel(id: 3, title: "The Dark Knight", originalTitle: "The Dark Knight", overview: "Batman sets out to dismantle the remaining criminal organizations that plague the streets.", popularity: 85.1, posterPath: "/poster3.jpg", backdropPath: "/backdrop3.jpg", releaseDate: "2008-07-18", voteAverage: 9.0, voteCount: 25192, genreIDs: [28, 80, 18], adult: false, video: false),
            MovieModel(id: 4, title: "Pulp Fiction", originalTitle: "Pulp Fiction", overview: "The lives of two mob hitmen, a boxer, and others intertwine in four tales of violence and redemption.", popularity: 69.7, posterPath: "/poster4.jpg", backdropPath: "/backdrop4.jpg", releaseDate: "1994-10-14", voteAverage: 8.9, voteCount: 23211, genreIDs: [80, 18], adult: false, video: false),
            MovieModel(id: 5, title: "The Matrix", originalTitle: "The Matrix", overview: "A computer hacker learns about the true nature of reality and his role in the war against its controllers.", popularity: 79.4, posterPath: "/poster5.jpg", backdropPath: "/backdrop5.jpg", releaseDate: "1999-03-31", voteAverage: 8.7, voteCount: 19052, genreIDs: [28, 878], adult: false, video: false),
            MovieModel(id: 6, title: "Fight Club", originalTitle: "Fight Club", overview: "An insomniac office worker forms an underground fight club.", popularity: 72.8, posterPath: "/poster6.jpg", backdropPath: "/backdrop6.jpg", releaseDate: "1999-10-15", voteAverage: 8.8, voteCount: 19501, genreIDs: [18], adult: false, video: false),
            MovieModel(id: 7, title: "Forrest Gump", originalTitle: "Forrest Gump", overview: "The presidencies of Kennedy and Johnson and events of the 20th century unfold from the perspective of a man with an IQ of 75.", popularity: 78.2, posterPath: "/poster7.jpg", backdropPath: "/backdrop7.jpg", releaseDate: "1994-07-06", voteAverage: 8.8, voteCount: 21115, genreIDs: [18, 35, 10749], adult: false, video: false),
            MovieModel(id: 8, title: "The Godfather", originalTitle: "The Godfather", overview: "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", popularity: 81.4, posterPath: "/poster8.jpg", backdropPath: "/backdrop8.jpg", releaseDate: "1972-03-14", voteAverage: 9.2, voteCount: 18452, genreIDs: [80, 18], adult: false, video: false),
            MovieModel(id: 9, title: "The Shawshank Redemption", originalTitle: "The Shawshank Redemption", overview: "Two imprisoned men bond over a number of years.", popularity: 83.5, posterPath: "/poster9.jpg", backdropPath: "/backdrop9.jpg", releaseDate: "1994-09-22", voteAverage: 9.3, voteCount: 21175, genreIDs: [18, 80], adult: false, video: false),
            MovieModel(id: 10, title: "Gladiator", originalTitle: "Gladiator", overview: "A former Roman General sets out to exact vengeance against the corrupt emperor.", popularity: 77.2, posterPath: "/poster10.jpg", backdropPath: "/backdrop10.jpg", releaseDate: "2000-05-01", voteAverage: 8.5, voteCount: 19023, genreIDs: [28, 18, 12], adult: false, video: false)
        ]
...
//                            print(person.name)
                            ...
                            print(personModel.originalName)
